...
class NewPlaceViewController: UITableViewController {//этот класс необходим для работы с клавиатурой на экране созлания нового места
    ...
    var newPlace = Place() //присвоим сам обьект модели данных
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {//сохранение обьектов в БД в фоновом режиме
            self.newPlace.savePlaces()//вызываем у экземпляра модели метод по сохрению обьектов БД
        }
